          ...
          <div className="row">
            ...
            <div className="col-xl-2 col-lg-2 col-md-6">
              <div>
                ...
                <ul className="list-unstyled">
                  <li>
                    <a href="https://github.com/AmitHendler" target='blank' className="text-decoration-none">
                      <span><FaGithub size={15} className='SocialMediaIcon'/>&nbsp;</span>
                      Personal GitHub
                    </a>
                  </li>
                  <li>
                    <a href="https://www.facebook.com/AmitHendler/" target='blank' className="text-decoration-none">
                      <span><FaFacebook size={15} className='SocialMediaIcon'/>&nbsp;</span>
                      Facebook
                    </a>
                  </li>
                  <li>
                    <a href="https://www.instagram.com/AmitHendler/" target='blank' className="text-decoration-none">
                      <span><FaInstagram size={15} className='SocialMediaIcon'/>&nbsp;</span>
                      Instagram
                    </a>
                  </li>
                  <li>
                    <a href="https://www.linkedin.com/in/AmitHendler/" target='blank' className="text-decoration-none">
