...
export default function SignIn() {
  ...
  const [email,setEmail] = useState<string>('AmitHendler@gmail.com');
  const [password,setPassword] = useState<string>('AmitHendler123!');
  ...
  return (
    <div className='SignIn Page'>
      ...
      <div className="option">
        ...
        my new acount: AmitHendler@gmail.com <br></br>
        Password: AmitHendler123!
