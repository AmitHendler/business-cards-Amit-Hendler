...
export default function SignUp() {
  ...
  const [firstName, setFirstName] = useState<string>('Shimrit')
  const [lastName, setLastName] = useState<string>('Harari')
  const [phone,setPhone] = useState<string>('0545381648')
  const [email, setEmail] = useState<string>('Shimrit555@gmail.com');
  const [password, setPassword] = useState<string>('shimiha!135');
  const [passwordVerification, setPasswordVerification] = useState<string>('shimiha!135');
  const [country, setCountry] = useState<string>('Israel');
  const [city, setCity] = useState<string>('Raanana');
  const [street, setStreet] = useState<string>('hahagana');
  const [houseNumber, setHouseNumber] = useState<string>('8');
  const [zipCode, setZipCode] = useState<string>('458754');
